...
["Notex2", "Notex2/notex2.dart", , Y, {
  "^": "",
  htmlEscape: function(source) {
    return J.replaceAll$2$s(J.replaceAll$2$s(source, "<", "&lt;"), ">", "&gt;");
  },
  Article: {
    "^": "Element0;name:Notex20$Article$name>,title*,name,parent,children,attributes",
    parentSearch$1: function($name) {
      if ($name === "article")
        return true;
      else
        return false;
    },
    toHtml$2: function(id, hierarchy) {
      var t1, t2, html;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), t2 = hierarchy + 1, html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$2(id, t2));
      return "<!-- Generated by Notex2 (c) syuilo. -->\n<article>\n" + html + "</article>";
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    },
    genelateTableOfContentsHtml$1: function(id) {
      var t1, html;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), html = ""; t1.moveNext$0();)
        html += t1.__internal$_current.genelateTableOfContentsHtml$1(id);
      return "<div class=\"tableOfContents\" id=\"" + id + "-tableOfContents\"><ol>" + html + "</ol></div>";
    }
  },
  Blockquote: {
    "^": "Element0;name:Notex20$Blockquote$name>,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var t1, t2, html;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), t2 = hierarchy + 1, html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$2(id, t2));
      return C.JSString_methods.$mul("    ", hierarchy) + ("<blockquote>\n" + html) + C.JSString_methods.$mul("    ", hierarchy) + "</blockquote>\n";
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    },
    static: {Blockquote_check: function(scanner, token) {
        return token.get$token() === "newline" && scanner.pick$1(token.id + 1).token === "newline" && scanner.pick$1(token.id + 2).token === "less_than";
      }, Blockquote_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "blockquote", 0, filter.length) > -1)
            return;
        return Y.Blockquote_generate(parser, $parent, null, null);
      }, Blockquote_generate: function(parser, $parent, inspecter, filter) {
        var blockquote = new Y.Blockquote("blockquote", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        blockquote.parent = $parent;
        parser.scanner.pos += 3;
        blockquote.children = parser.analyze$3(blockquote, new Y.Blockquote_generate_closure(parser), filter);
        return blockquote;
      }}
  },
  Blockquote_generate_closure: {
    "^": "Closure:8;parser_0",
    call$1: function(token) {
      var t1, t2;
      if (token.get$token() === "newline") {
        t1 = this.parser_0.scanner.tokens;
        t2 = token.id + 1;
        if (t2 < 0 || t2 >= t1.length)
          return H.ioore(t1, t2);
        t2 = t1[t2].token === "newline";
        t1 = t2;
      } else
        t1 = false;
      if (t1)
  ...
  Code: {
    "^": "Element0;name:Notex20$Code$name>,code*,lang*,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      return "<code data-lang=\"" + H.S(this.lang) + "\">" + H.S(this.code) + "</code>";
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    },
    static: {Code_check: function(scanner, token) {
        return token.token === "quotation" && scanner.pick$1(token.id + 1).token === "quotation" && scanner.pick$1(token.id + 2).token !== "quotation";
      }, Code_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "code", 0, filter.length) > -1)
            return;
        return Y.Code_generate(parser, $parent);
      }, Code_generate: function(parser, $parent) {
        var startToken, code, t1;
        startToken = parser.scanner.read$0();
        code = new Y.Code("code", "", "plain", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        code.parent = $parent;
        t1 = parser.scanner;
        t1.pos += 2;
        t1.scan$2(new Y.Code_generate_closure(parser, code), new Y.Code_generate_closure0(parser, startToken));
        code.code = Y.htmlEscape(J.trim$0$s(code.code));
        code.lang = Y.htmlEscape(code.lang);
        return code;
      }}
  },
  Code_generate_closure: {
    "^": "Closure:9;parser_0,code_1",
    call$1: function(token) {
      var target, t1, t2, t3, t4, t5;
      switch (token.token) {
        case "escape":
          target = 1;
          break;
        ...
        for (t1 = this.parser_0; true;)
          switch (target) {
            case 1:
              ...
              t4 = t3.get$code(t2);
              t5 = t1.scanner;
              t3.set$code(t2, J.$add$ns(t4, t5.pick$1(t5.pos).lexeme));
              break c$0;
            case 2:
              t2 = t1.scanner;
              if (t2.pick$1(t2.pos + 1).token === "quotation") {
                t2 = t1.scanner;
                t2 = t2.pick$1(t2.pos + 2).token !== "quotation";
              } else
                t2 = false;
              if (t2) {
                ++t1.scanner.pos;
            ...
            case 3:
              t2 = this.code_1;
              t3 = J.getInterceptor$x(t2);
              t3.set$code(t2, J.$add$ns(t3.get$code(t2), token.lexeme));
              break c$0;
          }
      ++t1.scanner.pos;
    },
  ...
  Code_generate_closure0: {
    "^": "Closure:10;parser_2,startToken_3",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = this.startToken_3;
      t2 = "" + t1.row + "\u884c\u76ee\u306e" + t1.col + "\u5217\u76ee\u3042\u305f\u308a\u304b\u3089\u59cb\u307e\u3063\u305f Code('') \u304c\u9589\u3058\u3066\u3044\u307e\u305b\u3093\u3002";
      t3 = t1.row;
      t1 = t1.col;
      t4 = new Y.Error0("", 0, 0);
      t4.description = t2;
  ...
  Element0: {
    ...
    genelateTableOfContentsHtml$1: function(id) {
      var t1, html;
      if (this.get$name(this) === "section")
        if (this.childFind$1("section")) {
          for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), html = ""; t1.moveNext$0();)
            html += t1.__internal$_current.genelateTableOfContentsHtml$1(id);
          return "<li class=\"section\"><a href=\"#" + id + "-" + this.get$number() + "\">" + H.S(this.title) + "</a><ol>" + html + "</ol></li>";
        } else
          return "<li><a href=\"#" + id + "-" + this.get$number() + "\">" + H.S(this.title) + "</a></li>";
      else
        return "";
    },
    parentSearch$1: function($name) {
      if ($name === this.get$name(this))
        return true;
      else
        return this.parent.parentSearch$1($name);
    },
    childFind$1: function($name) {
      var t1;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        if (t1.__internal$_current.childSearch$1($name))
          return true;
      return false;
    },
    childSearch$1: function($name) {
      var t1;
      if ($name === this.get$name(this))
        return true;
      else {
  ...
  Image: {
    "^": "Element0;name:Notex20$Image$name>,url*,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      return "<img src=\"" + H.S(this.url) + "\" alt=\"image\"/>";
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    },
    static: {Image_check: function(scanner, token) {
        return token.token === "exclamation_mark" && scanner.pick$1(token.id + 1).token === "open_bracket";
      }, Image_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "image", 0, filter.length) > -1)
            return;
        return Y.Image_generate(parser, $parent);
      }, Image_generate: function(parser, $parent) {
        var startToken, img, t1;
        startToken = parser.scanner.read$0();
        img = new Y.Image("image", "", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        img.parent = $parent;
        t1 = parser.scanner;
        t1.pos += 2;
        t1.scan$2(new Y.Image_generate_closure(parser, img), new Y.Image_generate_closure0(parser, startToken));
        img.url = Y.htmlEscape(img.url);
        return img;
      }}
  },
  Image_generate_closure: {
    "^": "Closure:9;parser_0,img_1",
    call$1: function(token) {
      var t1, t2;
      switch (token.token) {
        case "close_bracket":
        ...
        default:
          ...
          t2.set$url(t1, J.$add$ns(t2.get$url(t1), token.lexeme));
          break;
      }
      ++this.parser_0.scanner.pos;
    },
    $isFunction: true
  },
  Image_generate_closure0: {
    "^": "Closure:10;parser_2,startToken_3",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = this.startToken_3;
      t2 = "" + t1.row + "\u884c\u76ee\u306e" + t1.col + "\u5217\u76ee\u3042\u305f\u308a\u304b\u3089\u59cb\u307e\u3063\u305f Image(!) \u304c\u9589\u3058\u3066\u3044\u307e\u305b\u3093\u3002";
      t3 = t1.row;
      t1 = t1.col;
      t4 = new Y.Error0("", 0, 0);
      t4.description = t2;
  ...
  Keyword: {
    "^": "Element0;name:Notex20$Keyword$name>,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var t1, html;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$0());
      return "<b>" + html + "</b>";
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    },
    static: {Keyword_check: function(scanner, token) {
        return token.token === "asterisk" && scanner.pick$1(token.id + 1).token !== "asterisk";
      }, Keyword_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "keyword", 0, filter.length) > -1)
            return;
        return Y.Keyword_generate(parser, $parent, inspecter, filter);
      }, Keyword_generate: function(parser, $parent, inspecter, filter) {
        var startToken, keyword;
        startToken = parser.scanner.read$0();
        keyword = new Y.Keyword("keyword", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        keyword.parent = $parent;
        ++parser.scanner.pos;
        if (filter == null)
          filter = ["paragraph"];
        else
          filter.push("paragraph");
        keyword.children = parser.analyze$4(keyword, new Y.Keyword_generate_closure(parser), filter, new Y.Keyword_generate_closure0(parser, startToken));
        return keyword;
      }}
  },
  Keyword_generate_closure: {
    "^": "Closure:8;parser_0",
    call$1: function(token) {
      var t1, t2;
      if (token.get$token() === "asterisk") {
        t1 = this.parser_0.scanner.tokens;
        t2 = token.id + 1;
        if (t2 < 0 || t2 >= t1.length)
          return H.ioore(t1, t2);
        t2 = t1[t2].token !== "asterisk";
        t1 = t2;
      } else
        t1 = false;
      return t1;
  ...
  Keyword_generate_closure0: {
    "^": "Closure:10;parser_1,startToken_2",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = this.startToken_2;
      t2 = "" + t1.row + "\u884c\u76ee\u306e" + t1.col + "\u5217\u76ee\u3042\u305f\u308a\u304b\u3089\u59cb\u307e\u3063\u305f Keyword(*) \u304c\u9589\u3058\u3066\u3044\u307e\u305b\u3093\u3002";
      t3 = t1.row;
      t1 = t1.col;
      t4 = new Y.Error0("", 0, 0);
      t4.description = t2;
      t4.row = t3;
      t4.col = t1;
      this.parser_1.errors.push(t4);
    },
    $isFunction: true
  },
  Link: {
    "^": "Element0;name:Notex20$Link$name>,url*,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var t1, html;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$0());
      return "<a href=\"" + H.S(this.url) + "\" target=\"_blank\">" + html + "</a>";
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    },
    static: {Link_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "link", 0, filter.length) > -1)
            return;
        return Y.Link_generate(parser, $parent, inspecter, filter);
      }, Link_generate: function(parser, $parent, inspecter, filter) {
        var startToken, link, t1;
        startToken = parser.scanner.read$0();
        link = new Y.Link("link", "", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        link.parent = $parent;
        t1 = parser.scanner;
        ++t1.pos;
        t1.scan$2(new Y.Link_generate_closure(parser, filter, link), new Y.Link_generate_closure0(parser, startToken));
        t1 = parser.scanner;
        t1.pos += 2;
        t1.scan$2(new Y.Link_generate_closure1(parser, link), new Y.Link_generate_closure2(parser, startToken));
        link.url = Y.htmlEscape(link.url);
        return link;
      }}
  },
  Link_generate_closure: {
    "^": "Closure:9;parser_0,filter_1,link_2",
    call$1: function(token) {
      var t1 = this.link_2;
      t1.children = this.parser_0.analyze$3(t1, new Y.Link_generate__closure(), this.filter_1);
      return true;
    },
    $isFunction: true
  },
  Link_generate__closure: {
    "^": "Closure:8;",
    call$1: function(token) {
      return token.get$token() === "close_square_bracket";
    },
    $isFunction: true
  },
  Link_generate_closure0: {
    "^": "Closure:10;parser_3,startToken_4",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = this.startToken_4;
      t2 = "" + t1.row + "\u884c\u76ee\u306e" + t1.col + "\u5217\u76ee\u3042\u305f\u308a\u304b\u3089\u59cb\u307e\u3063\u305f Link([) \u304c\u9589\u3058\u3066\u3044\u307e\u305b\u3093\u3002";
      t3 = t1.row;
      t1 = t1.col;
      t4 = new Y.Error0("", 0, 0);
      t4.description = t2;
      t4.row = t3;
      t4.col = t1;
      this.parser_3.errors.push(t4);
    },
    $isFunction: true
  },
  Link_generate_closure1: {
    "^": "Closure:9;parser_5,link_6",
    call$1: function(token) {
      var t1, t2;
      switch (token.token) {
        case "close_bracket":
      ...
      ++this.parser_5.scanner.pos;
    },
    $isFunction: true
  },
  Link_generate_closure2: {
    "^": "Closure:10;parser_7,startToken_8",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = this.startToken_8;
      t2 = "" + t1.row + "\u884c\u76ee\u306e" + t1.col + "\u5217\u76ee\u3042\u305f\u308a\u304b\u3089\u59cb\u307e\u3063\u305f Link([) \u304c\u9589\u3058\u3066\u3044\u307e\u305b\u3093\u3002";
      t3 = t1.row;
      t1 = t1.col;
      t4 = new Y.Error0("", 0, 0);
      ...
      t4.row = t3;
      t4.col = t1;
      this.parser_7.errors.push(t4);
    },
    $isFunction: true
  },
  EList: {
    "^": "Element0;name:Notex20$EList$name>,type,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var t1, t2, html, tag;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), t2 = hierarchy + 1, html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$2(id, t2));
      ...
      t1 = this.parent;
      if (t1.get$name(t1) === "list_item")
        return "\n" + C.JSString_methods.$mul("    ", hierarchy) + ("<" + tag + ">\n" + html) + C.JSString_methods.$mul("    ", hierarchy) + ("</" + tag + ">\n") + C.JSString_methods.$mul("    ", hierarchy - 1);
      else
        return C.JSString_methods.$mul("    ", hierarchy) + ("<" + tag + ">\n" + html) + C.JSString_methods.$mul("    ", hierarchy) + ("</" + tag + ">\n");
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    },
    static: {EList_check: function(scanner, token) {
        var t1;
        if (token.get$token() === "newline")
          if (scanner.pick$1(token.id + 1).token !== "hyphen")
            t1 = scanner.pick$1(token.id + 1).token === "number" && scanner.pick$1(token.id + 2).token === "period";
          else
            t1 = true;
        else
          t1 = false;
        return t1;
      }, EList_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "list", 0, filter.length) > -1)
            return;
        return Y.EList_generate(parser, $parent);
      }, EList_generate: function(parser, $parent) {
        var t1, startToken, list, t2;
        t1 = {};
        startToken = parser.scanner.read$0();
        list = new Y.EList("list", "unordered", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        list.parent = $parent;
        t2 = parser.scanner;
        ++t2.pos;
        t1.hierarchy_5 = 0;
        t2.scan$1(new Y.EList_generate_closure(t1, parser, list));
        parser.scanner.scan$2(new Y.EList_generate_closure0(t1, parser, list), new Y.EList_generate_closure1(parser, startToken));
        --parser.scanner.pos;
        return list;
      }, EList_getNextHierarchy: function(parser) {
        var t1 = {};
        t1.step_0 = 0;
        t1.nextHierarchy_1 = 0;
        parser.scanner.scan$1(new Y.EList_getNextHierarchy_closure(t1, parser));
        parser.scanner.pos -= t1.step_0;
        return t1.nextHierarchy_1;
      }, EList_getNextStep: function(parser) {
        var t1 = {};
        t1.step_0 = 0;
        t1.nextStep_1 = 0;
        parser.scanner.scan$1(new Y.EList_getNextStep_closure(t1, parser));
        parser.scanner.pos -= t1.step_0;
        return t1.nextStep_1;
      }}
  },
  EList_generate_closure: {
    "^": "Closure:9;box_1,parser_2,list_3",
    call$1: function(token) {
      var t1 = token.token;
      if (t1 === "hyphen") {
        ++this.box_1.hierarchy_5;
        this.list_3.type = "unordered";
      } else if (t1 === "number" && this.parser_2.scanner.pick$1(token.id + 1).token === "period") {
        ++this.box_1.hierarchy_5;
        this.list_3.type = "ordered";
        ++this.parser_2.scanner.pos;
  ...
  EList_generate_closure0: {
    "^": "Closure:9;box_1,parser_4,list_5",
    call$1: function(token) {
      var t1, item, t2, t3, t4, t5;
      t1 = {};
      item = new Y.EListItem("list_item", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = this.list_5;
      item.parent = t2;
      t1.childList_0 = null;
      t1.childListType_1 = "";
      t1.exit_2 = false;
      t1.nextHierarchy_3 = 0;
      t1.isDummy_4 = false;
      t3 = this.parser_4;
      t4 = t3.analyze$3(item, new Y.EList_generate__closure(t1, this.box_1, t3, item), ["paragraph"]);
      item.children = t4;
      if (t1.exit_2) {
        if (!t1.isDummy_4)
          t2.children.push(item);
        return true;
      }
      t5 = t1.childList_0;
      if (t5 != null) {
      ...
      if (!t1.isDummy_4)
        t2.children.push(item);
      if (t3.scanner.read$1(1).token === "newline") {
        ++t3.scanner.pos;
        return true;
      }
      ++t3.scanner.pos;
  ...
  EList_generate__closure: {
    "^": "Closure:8;box_0,box_1,parser_6,item_7",
    call$1: function(token) {
      var t1, t2, t3, nextStep, t4, t5, t6, childList;
      t1 = this.parser_6;
      t2 = J.getInterceptor$x(token);
      if (t1.scanner.pick$1(t2.get$id(token)).token === "dummy")
        this.box_0.isDummy_4 = true;
      if (t1.scanner.pick$1(t2.get$id(token)).token === "newline")
        if (t1.scanner.pick$1(J.$add$ns(t2.get$id(token), 1)).token !== "hyphen")
          t3 = t1.scanner.pick$1(J.$add$ns(t2.get$id(token), 1)).token === "number" && t1.scanner.pick$1(J.$add$ns(t2.get$id(token), 2)).token === "period";
        else
          t3 = true;
      else
        t3 = false;
      if (t3) {
        t2 = t1.scanner.pick$1(J.$add$ns(t2.get$id(token), 1)).token === "number" && t1.scanner.pick$1(J.$add$ns(t2.get$id(token), 2)).token === "period";
        t3 = this.box_0;
        if (t2)
          t3.childListType_1 = "ordered";
        else
          t3.childListType_1 = "unordered";
        ++t1.scanner.pos;
        t3.nextHierarchy_3 = Y.EList_getNextHierarchy(t1);
        nextStep = Y.EList_getNextStep(t1);
        t2 = t1.scanner;
        t4 = --t2.pos;
        t5 = this.box_1.hierarchy_5;
        t6 = t3.nextHierarchy_3;
        if (t5 > t6) {
          t2.pos = t4 - 1;
          t1 = t2.tokens;
          t2 = t2.read$0().id;
          ...
          childList = new Y.EList("list", "unordered", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
          t3.childList_0 = childList;
          childList.parent = this.item_7;
          t3.childList_0 = Y.EList_generate(t1, childList);
        }
      }
      if (token.get$token() === "newline")
        return true;
  ...
  EList_generate_closure1: {
    "^": "Closure:10;parser_8,startToken_9",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = this.startToken_9;
      t2 = "" + t1.row + "\u884c\u76ee\u306e" + t1.col + "\u5217\u76ee\u3042\u305f\u308a\u304b\u3089\u59cb\u307e\u3063\u305f List(- \u307e\u305f\u306f \u6570\u5b57.) \u304c\u9589\u3058\u3066\u3044\u307e\u305b\u3093\u3002";
      t3 = t1.row;
      t1 = t1.col;
      t4 = new Y.Error0("", 0, 0);
      t4.description = t2;
      t4.row = t3;
      t4.col = t1;
      this.parser_8.errors.push(t4);
    },
    $isFunction: true
  },
  EList_getNextHierarchy_closure: {
    "^": "Closure:9;box_0,parser_1",
    call$1: function(token) {
      var t1 = token.token;
      if (t1 === "hyphen")
        ++this.box_0.nextHierarchy_1;
      else if (t1 === "number" && this.parser_1.scanner.pick$1(token.id + 1).token === "period") {
        t1 = this.box_0;
        ++t1.nextHierarchy_1;
        ++t1.step_0;
        ++this.parser_1.scanner.pos;
      } else if (token.token === "space")
        ;
      else
        return true;
  ...
  EList_getNextStep_closure: {
    "^": "Closure:9;box_0,parser_1",
    call$1: function(token) {
      var t1 = token.token;
      if (t1 === "hyphen")
        ++this.box_0.nextStep_1;
      else if (t1 === "number" && this.parser_1.scanner.pick$1(token.id + 1).token === "period") {
        t1 = this.box_0;
        t1.nextStep_1 = ++t1.nextStep_1 + 1;
        ++t1.step_0;
        ++this.parser_1.scanner.pos;
      } else if (token.token === "space")
        ;
  ...
  EListItem: {
    "^": "Element0;name:Notex20$EListItem$name>,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var t1, t2, html;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), t2 = hierarchy + 1, html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$2(id, t2));
      return C.JSString_methods.$mul("    ", hierarchy) + ("<li>" + html + "</li>\n");
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    }
  ...
  MultiLineCode: {
    "^": "Element0;name:Notex20$MultiLineCode$name>,code*,lang*,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      return C.JSString_methods.$mul("    ", hierarchy) + ("<pre><code data-lang=\"" + H.S(this.lang) + "\">" + H.S(this.code) + "</code></pre>\n");
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    },
    static: {MultiLineCode_check: function(scanner, token) {
        return token.get$token() === "newline" && scanner.pick$1(token.id + 1).token === "quotation" && scanner.pick$1(token.id + 2).token === "quotation" && scanner.pick$1(token.id + 3).token === "quotation";
      }, MultiLineCode_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "multilinecode", 0, filter.length) > -1)
            return;
        return Y.MultiLineCode_generate(parser, $parent);
      }, MultiLineCode_generate: function(parser, $parent) {
        var startToken, code, t1;
        startToken = parser.scanner.read$0();
        code = new Y.MultiLineCode("multilinecode", "", "plain", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        code.parent = $parent;
        t1 = parser.scanner;
        t1.pos += 4;
        if (t1.read$0().token === "at_mark") {
          t1 = parser.scanner;
          ++t1.pos;
          code.lang = "";
          t1.scan$1(new Y.MultiLineCode_generate_closure(parser, code));
        }
        parser.scanner.scan$2(new Y.MultiLineCode_generate_closure0(parser, code), new Y.MultiLineCode_generate_closure1(parser, startToken));
        code.code = Y.htmlEscape(J.trim$0$s(code.code));
        code.lang = Y.htmlEscape(code.lang);
        return code;
      }}
  },
  MultiLineCode_generate_closure: {
    "^": "Closure:9;parser_0,code_1",
    call$1: function(token) {
      var t1, t2;
      switch (token.token) {
        ...
        default:
          t1 = this.code_1;
          t2 = J.getInterceptor$x(t1);
          t2.set$lang(t1, J.$add$ns(t2.get$lang(t1), token.lexeme));
          break;
      }
      ++this.parser_0.scanner.pos;
    },
  ...
  MultiLineCode_generate_closure0: {
    "^": "Closure:9;parser_2,code_3",
    call$1: function(token) {
      var target, t1, t2, t3, t4, t5;
      switch (token.token) {
        case "escape":
  ...
  MultiLineCode_generate_closure1: {
    "^": "Closure:10;parser_4,startToken_5",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = this.startToken_5;
      t2 = "" + t1.row + "\u884c\u76ee\u306e" + t1.col + "\u5217\u76ee\u3042\u305f\u308a\u304b\u3089\u59cb\u307e\u3063\u305f Code(''') \u304c\u9589\u3058\u3066\u3044\u307e\u305b\u3093\u3002";
      t3 = t1.row;
      t1 = t1.col;
      t4 = new Y.Error0("", 0, 0);
      ...
      t4.row = t3;
      t4.col = t1;
      this.parser_4.errors.push(t4);
    },
    $isFunction: true
  },
  Paragraph: {
    "^": "Element0;name:Notex20$Paragraph$name>,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var t1, html;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$0());
      html = C.JSString_methods.trim$0(html);
      H.checkString("</br>");
      html = H.stringReplaceAllUnchecked(html, "\n", "</br>");
      if (!J.$eq(html, ""))
        return C.JSString_methods.$mul("    ", hierarchy) + ("<p>" + H.S(html) + "</p>\n");
      else
        return "";
    },
    toHtml$0: function() {
    ...
    static: {Paragraph_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "paragraph", 0, filter.length) > -1)
            return;
        return Y.Paragraph_generate(parser, $parent, inspecter);
      }, Paragraph_generate: function(parser, $parent, inspecter) {
        var p = new Y.Paragraph("paragraph", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        p.parent = $parent;
        p.children = parser.analyze$2(p, new Y.Paragraph_generate_closure(parser, inspecter));
        return p;
      }}
  },
  Paragraph_generate_closure: {
    "^": "Closure:8;parser_0,inspecter_1",
    call$1: function(token) {
      var t1, t2;
      t1 = this.parser_0;
      if (Y.Section_check(t1.scanner, token))
        return true;
      else if (Y.EList_check(t1.scanner, token))
        return true;
      else if (Y.Blockquote_check(t1.scanner, token))
        return true;
      else if (Y.MultiLineCode_check(t1.scanner, token))
        return true;
      else if (Y.Table_check(t1.scanner, token))
        return true;
      else {
        t2 = this.inspecter_1;
        if (t2 != null)
          if (t2.call$1(token) === true)
            return true;
        if (token.get$token() === "newline" && t1.scanner.read$1(1).token === "newline") {
          ++t1.scanner.pos;
          return true;
        }
        return false;
  ...
  Section: {
    "^": "Element0;name:Notex20$Section$name>,hierarchy<,title*,number<,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var h, t1, t2, html, attribute;
      h = "h" + hierarchy;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), t2 = hierarchy + 1, html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$2(id, t2));
      attribute = id !== "" ? " id=\"#" + id + "-" + this.number + "\"" : "";
      return C.JSString_methods.$mul("    ", hierarchy) + ("<section" + attribute + ">\n") + C.JSString_methods.$mul("    ", t2) + ("<" + h + ">" + H.S(this.title) + "</" + h + ">\n") + html + C.JSString_methods.$mul("    ", hierarchy) + "</section>\n";
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    },
    static: {Section_check: function(scanner, token) {
        return token.get$token() === "newline" && scanner.pick$1(token.id + 1).token === "sharp";
      }, Section_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "section", 0, filter.length) > -1)
            return;
        return Y.Section_generate(parser, $parent);
      }, Section_generate: function(parser, $parent) {
        var t1, section, t2;
        t1 = {};
        ++parser.sectionCount;
        section = new Y.Section("section", null, "", 0, null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        ...
        t2 = parser.scanner;
        ++t2.pos;
        t2.scan$1(new Y.Section_generate_closure(t1, parser, section));
        section.title = Y.htmlEscape(J.trim$0$s(section.title));
        return section;
      }}
  },
  Section_generate_closure: {
    "^": "Closure:9;box_1,parser_2,section_3",
    call$1: function(token) {
      var t1, t2;
      t1 = this.box_1;
      if (!t1.secEnd_2)
        switch (token.token) {
          ...
          default:
            t1 = this.section_3;
            t2 = J.getInterceptor$x(t1);
            t2.set$title(t1, J.$add$ns(t2.get$title(t1), token.lexeme));
            break;
        }
      else {
        t1 = this.section_3;
        t2 = this.parser_2;
        J.set$children$x(t1, t2.analyze$2(t1, new Y.Section_generate__closure(t2, t1)));
        return true;
      }
      ++this.parser_2.scanner.pos;
    },
  ...
  Section_generate__closure: {
    "^": "Closure:8;parser_4,section_5",
    call$1: function(token) {
      var t1, t2, t3;
      t1 = {};
      t2 = this.parser_4;
      if (Y.Section_check(t2.scanner, token)) {
        t1.nextSectionHierarchy_0 = 0;
        t1.step_1 = 0;
        t3 = t2.scanner;
        ++t3.pos;
        t3.scan$1(new Y.Section_generate___closure(t1, t2));
        t2.scanner.pos -= t1.step_1 + 1;
        t1 = t1.nextSectionHierarchy_0;
        t3 = this.section_5.get$hierarchy();
        if (typeof t3 !== "number")
          return H.iae(t3);
        if (t1 <= t3) {
          --t2.scanner.pos;
  ...
  Section_generate___closure: {
    "^": "Closure:9;box_0,parser_6",
    call$1: function(secToken) {
      var t1;
      if (secToken.token === "sharp") {
        t1 = this.box_0;
        ++t1.nextSectionHierarchy_0;
        ++t1.step_1;
        ++this.parser_6.scanner.pos;
        return false;
      } else
        return true;
    },
  ...
  Strike: {
    "^": "Element0;name:Notex20$Strike$name>,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var t1, html;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$0());
    ...
    static: {Strike_check: function(scanner, token) {
        return token.token === "tilde" && scanner.pick$1(token.id + 1).token === "tilde";
      }, Strike_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "strike", 0, filter.length) > -1)
            return;
        return Y.Strike_generate(parser, $parent, inspecter, filter);
      }, Strike_generate: function(parser, $parent, inspecter, filter) {
        var startToken, strike;
        startToken = parser.scanner.read$0();
        strike = new Y.Strike("strike", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        strike.parent = $parent;
        parser.scanner.pos += 2;
        if (filter == null)
          filter = ["paragraph"];
        else
          filter.push("paragraph");
        strike.children = parser.analyze$4(strike, new Y.Strike_generate_closure(parser), filter, new Y.Strike_generate_closure0(parser, startToken));
        ++parser.scanner.pos;
        return strike;
      }}
  },
  Strike_generate_closure: {
    "^": "Closure:8;parser_0",
    call$1: function(token) {
      var t1, t2;
      if (token.get$token() === "tilde") {
        t1 = this.parser_0.scanner.tokens;
        t2 = token.id + 1;
        if (t2 < 0 || t2 >= t1.length)
          return H.ioore(t1, t2);
        t2 = t1[t2].token === "tilde";
        t1 = t2;
      } else
        t1 = false;
      return t1;
  ...
  Strike_generate_closure0: {
    "^": "Closure:10;parser_1,startToken_2",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = this.startToken_2;
      t2 = "" + t1.row + "\u884c\u76ee\u306e" + t1.col + "\u5217\u76ee\u3042\u305f\u308a\u304b\u3089\u59cb\u307e\u3063\u305f Strike(~~) \u304c\u9589\u3058\u3066\u3044\u307e\u305b\u3093\u3002";
      t3 = t1.row;
      t1 = t1.col;
      t4 = new Y.Error0("", 0, 0);
      t4.description = t2;
  ...
  Strong: {
    "^": "Element0;name:Notex20$Strong$name>,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var t1, html;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$0());
    ...
    static: {Strong_check: function(scanner, token) {
        return token.token === "asterisk" && scanner.pick$1(token.id + 1).token === "asterisk";
      }, Strong_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "strong", 0, filter.length) > -1)
            return;
        return Y.Strong_generate(parser, $parent, inspecter, filter);
      }, Strong_generate: function(parser, $parent, inspecter, filter) {
        var startToken, strong;
        startToken = parser.scanner.read$0();
        strong = new Y.Strong("strong", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        ...
        if (filter == null)
          ...
          filter.push("paragraph");
        strong.children = parser.analyze$4(strong, new Y.Strong_generate_closure(parser), filter, new Y.Strong_generate_closure0(parser, startToken));
        ++parser.scanner.pos;
        return strong;
      }}
  },
  Strong_generate_closure: {
    "^": "Closure:8;parser_0",
    call$1: function(token) {
      var t1, t2;
      if (token.get$token() === "asterisk") {
  ...
  Strong_generate_closure0: {
    "^": "Closure:10;parser_1,startToken_2",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = this.startToken_2;
      t2 = "" + t1.row + "\u884c\u76ee\u306e" + t1.col + "\u5217\u76ee\u3042\u305f\u308a\u304b\u3089\u59cb\u307e\u3063\u305f Strong(**) \u304c\u9589\u3058\u3066\u3044\u307e\u305b\u3093\u3002";
      t3 = t1.row;
      t1 = t1.col;
      t4 = new Y.Error0("", 0, 0);
      t4.description = t2;
  ...
  Table: {
    "^": "Element0;name:Notex20$Table$name>,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var t1, t2, html;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), t2 = hierarchy + 1, html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$2(id, t2));
      return C.JSString_methods.$mul("    ", hierarchy) + ("<table>\n" + html) + C.JSString_methods.$mul("    ", hierarchy) + "</table>\n";
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    },
    static: {Table_check: function(scanner, token) {
        return token.get$token() === "newline" && scanner.pick$1(token.id + 1).token === "vertical_bar";
      }, Table_analyze: function(parser, $parent, inspecter, filter) {
        if (filter != null)
          if (H.Lists_indexOf(filter, "table", 0, filter.length) > -1)
            return;
        return Y.Table_generate(parser, $parent);
      }, Table_generate: function(parser, $parent) {
        var table, t1;
        parser.scanner.read$0();
        table = new Y.Table("table", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        table.parent = $parent;
        t1 = parser.scanner;
        t1.pos += 2;
        t1.scan$1(new Y.Table_generate_closure(parser, table));
        return table;
      }}
  },
  Table_generate_closure: {
    "^": "Closure:9;parser_1,table_2",
    call$1: function(token) {
      var tr, t1, t2;
      if (token.token === "newline" && this.parser_1.scanner.pick$1(token.id + 1).token !== "vertical_bar")
        return true;
      tr = new Y.TableRow("table_row", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t1 = this.table_2;
      tr.parent = t1;
      t2 = this.parser_1;
      t2.scanner.scan$1(new Y.Table_generate__closure(t2, tr));
      t1.children.push(tr);
      ++t2.scanner.pos;
    },
    $isFunction: true
  },
  Table_generate__closure: {
    "^": "Closure:9;parser_3,tr_4",
    call$1: function(token) {
      var t1, t2, th, t3, td;
      t1 = {};
      if (token.token === "newline")
        return true;
      t2 = this.parser_3;
      if (t2.scanner.read$0().token === "vertical_bar") {
        ++t2.scanner.pos;
        th = new Y.TableHeader("table_header", 0, 0, null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        if (t2.scanner.read$0().token === "open_curly_bracket") {
          t3 = t2.scanner;
          ++t3.pos;
          t1.colspan_0 = "";
          t3.scan$1(new Y.Table_generate___closure(t1, t2));
          t3 = t1.colspan_0;
          if (t3 !== "")
            th.colspan = H.Primitives_parseInt(t3, null, null);
          t3 = t2.scanner;
          ++t3.pos;
          t1.rowspan_1 = "";
          t3.scan$1(new Y.Table_generate___closure0(t1, t2));
          t1 = t1.rowspan_1;
          if (t1 !== "")
            th.rowspan = H.Primitives_parseInt(t1, null, null);
          ++t2.scanner.pos;
        }
        t1 = this.tr_4;
        th.parent = t1;
        th.children = t2.analyze$3(th, new Y.Table_generate___closure1(), ["paragraph"]);
        t1.children.push(th);
        t1 = t2.scanner;
        ++t1.pos;
        if (t1.read$1(-1).token === "newline" && t2.scanner.read$0().token !== "vertical_bar") {
          t2.scanner.pos -= 2;
          return true;
        }
        if (t2.scanner.read$1(-1).token === "newline")
          return true;
      } else {
        td = new Y.TableData("table_data", 0, 0, null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        if (t2.scanner.read$0().token === "open_curly_bracket") {
          t3 = t2.scanner;
          ++t3.pos;
          t1.colspan_2 = "";
          t3.scan$1(new Y.Table_generate___closure2(t1, t2));
          t3 = t1.colspan_2;
          if (t3 !== "")
            td.colspan = H.Primitives_parseInt(t3, null, null);
          t3 = t2.scanner;
          ++t3.pos;
          t1.rowspan_3 = "";
          t3.scan$1(new Y.Table_generate___closure3(t1, t2));
          t1 = t1.rowspan_3;
          if (t1 !== "")
            td.rowspan = H.Primitives_parseInt(t1, null, null);
          ++t2.scanner.pos;
        }
        t1 = this.tr_4;
        td.parent = t1;
        td.children = t2.analyze$3(td, new Y.Table_generate___closure4(), ["paragraph"]);
        t1.children.push(td);
        t1 = t2.scanner;
        ++t1.pos;
        if (t1.read$1(-1).token === "newline" && t2.scanner.read$0().token !== "vertical_bar") {
  ...
  Table_generate___closure: {
    "^": "Closure:9;box_0,parser_5",
    call$1: function(token) {
      var t1;
      switch (token.token) {
        case "number":
          t1 = this.box_0;
          t1.colspan_0 = t1.colspan_0 + token.lexeme;
          break;
        default:
          return true;
      }
  ...
  Table_generate___closure0: {
    ...
    call$1: function(token) {
      ...
      switch (token.token) {
        case "number":
          t1 = this.box_0;
          t1.rowspan_1 = t1.rowspan_1 + token.lexeme;
          break;
        default:
          return true;
      }
  ...
  Table_generate___closure1: {
    "^": "Closure:8;",
    call$1: function(token) {
      return token.get$token() === "vertical_bar" || token.token === "newline";
    },
    $isFunction: true
  },
  Table_generate___closure2: {
    "^": "Closure:9;box_0,parser_7",
    call$1: function(token) {
      var t1;
      switch (token.token) {
        case "number":
          t1 = this.box_0;
          t1.colspan_2 = t1.colspan_2 + token.lexeme;
          break;
        default:
          return true;
      }
      ++this.parser_7.scanner.pos;
    },
    $isFunction: true
  },
  Table_generate___closure3: {
    "^": "Closure:9;box_0,parser_8",
    call$1: function(token) {
      var t1;
      switch (token.token) {
        case "number":
          t1 = this.box_0;
          t1.rowspan_3 = t1.rowspan_3 + token.lexeme;
          break;
        default:
          return true;
      }
      ++this.parser_8.scanner.pos;
    },
    $isFunction: true
  },
  Table_generate___closure4: {
    "^": "Closure:8;",
    call$1: function(token) {
      return token.get$token() === "vertical_bar" || token.token === "newline";
    },
  ...
  TableData: {
    "^": "Element0;name:Notex20$TableData$name>,colspan,rowspan,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var attribute, t1, html;
      attribute = J.$gt$n(this.colspan, 0) ? " colspan=\"" + H.S(this.colspan) + "\"" : "";
      if (J.$gt$n(this.rowspan, 0))
        attribute += " rowspan=\"" + H.S(this.rowspan) + "\"";
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$0());
      html = C.JSString_methods.trim$0(html);
  ...
  TableHeader: {
    "^": "Element0;name:Notex20$TableHeader$name>,colspan,rowspan,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var attribute, t1, html;
      attribute = J.$gt$n(this.colspan, 0) ? " colspan=\"" + H.S(this.colspan) + "\"" : "";
      if (J.$gt$n(this.rowspan, 0))
  ...
  TableRow: {
    "^": "Element0;name:Notex20$TableRow$name>,name,parent,children,attributes",
    toHtml$2: function(id, hierarchy) {
      var t1, html;
      for (t1 = this.children, t1 = new H.ListIterator(t1, t1.length, 0, null), html = ""; t1.moveNext$0();)
        html = C.JSString_methods.$add(html, t1.__internal$_current.toHtml$0());
      return C.JSString_methods.$mul("    ", hierarchy) + ("<tr>" + html + "</tr>\n");
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    }
  ...
  Text: {
    "^": "Element0;name:Notex20$Text$name>,text,name,parent,children,attributes",
    childFind$1: function($name) {
      return false;
    },
    childSearch$1: function($name) {
      if ($name === this.Notex20$Text$name)
        return true;
      else
        return false;
    },
    toHtml$2: function(id, hierarchy) {
      return Y.htmlEscape(this.text);
    },
    toHtml$0: function() {
      return this.toHtml$2("", 0);
    },
    static: {Text_generate: function(parser, $parent, inspecter, filter) {
        var text = new Y.Text("text", "", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        text.parent = $parent;
        parser.scanner.scan$1(new Y.Text_generate_closure(parser, inspecter, text));
        return text;
      }}
  },
  Text_generate_closure: {
    "^": "Closure:9;parser_0,inspecter_1,text_2",
    call$1: function(token) {
      var t1 = this.inspecter_1;
      if (t1 != null)
        if (t1.call$1(token) === true)
          return true;
      t1 = this.parser_0;
      if (Y.Blockquote_check(t1.scanner, token))
        return true;
      else if (Y.MultiLineCode_check(t1.scanner, token))
        return true;
      else if (Y.Image_check(t1.scanner, token))
        return true;
      else if (token.token === "open_square_bracket")
        return true;
      else if (Y.EList_check(t1.scanner, token))
        return true;
      else if (Y.Section_check(t1.scanner, token))
        return true;
      else if (Y.Strike_check(t1.scanner, token))
        return true;
      else if (Y.Strong_check(t1.scanner, token))
        return true;
      else {
        this.text_2.text = token.lexeme;
        return true;
      }
    },
    $isFunction: true
  ...
  Lexer: {
    "^": "Object;source",
    analyze$0: function() {
      var t1, tokens, t2, id, token;
      t1 = {};
      tokens = [];
      t1.pos_0 = 0;
      t1.row_1 = 1;
      t1.col_2 = 1;
      t2 = new Y.Lexer_analyze_tokeniza(t1, this);
      for (id = 0; t1.pos_0 < J.get$length$asx(this.source);) {
        token = t2.call$0();
        J.set$id$x(token, id);
        ++id;
        tokens.push(token);
      }
      token = new Y.Token(0, "", "", 0, 0);
      token.id = id;
      token.token = "eof";
      token.lexeme = "";
      tokens.push(token);
  ...
  Lexer_analyze_tokeniza: {
    "^": "Closure:11;box_0,this_1",
    call$0: function() {
      var token, t1, t2, text, $char, t3;
      token = new Y.Token(0, "", "", 0, 0);
      t1 = this.box_0;
      token.row = t1.row_1;
      token.col = t1.col_2;
      t2 = this.this_1;
      if (J.get$length$asx(t2.source) === 0)
        return;
      for (text = false; t1.pos_0 < J.get$length$asx(t2.source); text = true) {
        $char = J.$index$asx(t2.source, t1.pos_0);
        t3 = ++t1.pos_0;
        switch ($char) {
          case "\\":
            if (!text) {
  ...
  Token: {
    "^": "Object;id*,token<,lexeme,row,col"
  },
  Notex2: {
    "^": "Object;source,id*,parser",
    compile$0: function() {
      var t1, t2, article;
      t1 = new Y.Lexer(null);
      t1.source = this.source;
      t2 = new Y.Scanner(null, -1);
      t2.tokens = t1.analyze$0();
      t1 = new Y.Parser(null, 0, []);
      t1.scanner = t2;
      this.parser = t1;
      article = new Y.Article("article", "", null, null, [], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      article.title = this.id;
      article.children = this.parser.analyze$2(article, new Y.Notex2_compile_closure());
      return article;
    }
  },
  Notex2_compile_closure: {
    "^": "Closure:8;",
    call$1: function(token) {
      return false;
    },
  ...
  Error0: {
    "^": "Object;description<,row,col"
  },
  Parser: {
    "^": "Object;scanner,sectionCount,errors",
    analyze$4: function($parent, inspecter, filter, scanEnd) {
      var elements = [];
      this.scanner.scan$2(new Y.Parser_analyze_closure(this, $parent, inspecter, filter, elements), scanEnd);
      return elements;
    },
    analyze$2: function(parent, inspecter) {
      return this.analyze$4(parent, inspecter, null, null);
    },
    analyze$3: function(parent, inspecter, filter) {
      return this.analyze$4(parent, inspecter, filter, null);
    }
  },
  Parser_analyze_closure: {
    "^": "Closure:9;this_0,parent_1,inspecter_2,filter_3,elements_4",
    call$1: function(token) {
      ...
      if (t1 != null)
        if (t1.call$1(token) === true)
          return true;
      t2 = this.parent_1;
      if (!t2.parentSearch$1("paragraph")) {
        t3 = this.this_0;
        if (Y.Keyword_check(t3.scanner, token) || Y.Strong_check(t3.scanner, token) || Y.Strike_check(t3.scanner, token) || token.token === "open_square_bracket" || Y.Code_check(t3.scanner, token)) {
          --t3.scanner.pos;
          element = Y.Paragraph_analyze(t3, t2, t1, this.filter_3);
          if (element != null) {
            this.elements_4.push(element);
            token = t3.scanner.read$0();
          } else
            ++t3.scanner.pos;
        }
      }
      switch (token.token) {
        ...
        default:
          t3 = this.this_0;
          if (Y.Blockquote_check(t3.scanner, token))
            element = Y.Blockquote_analyze(t3, t2, t1, this.filter_3);
          else if (Y.Code_check(t3.scanner, token))
            element = Y.Code_analyze(t3, t2, t1, this.filter_3);
          else if (Y.MultiLineCode_check(t3.scanner, token))
            element = Y.MultiLineCode_analyze(t3, t2, t1, this.filter_3);
          else if (Y.Image_check(t3.scanner, token))
            element = Y.Image_analyze(t3, t2, t1, this.filter_3);
          else if (Y.Keyword_check(t3.scanner, token))
            element = Y.Keyword_analyze(t3, t2, t1, this.filter_3);
          else if (token.token === "open_square_bracket")
            element = Y.Link_analyze(t3, t2, t1, this.filter_3);
          else if (Y.EList_check(t3.scanner, token))
            element = Y.EList_analyze(t3, t2, t1, this.filter_3);
          else if (Y.Section_check(t3.scanner, token))
            element = Y.Section_analyze(t3, t2, t1, this.filter_3);
          else if (Y.Strike_check(t3.scanner, token))
            element = Y.Strike_analyze(t3, t2, t1, this.filter_3);
          else if (Y.Strong_check(t3.scanner, token))
            element = Y.Strong_analyze(t3, t2, t1, this.filter_3);
          else if (Y.Table_check(t3.scanner, token))
            element = Y.Table_analyze(t3, t2, t1, this.filter_3);
          else {
            if (!t2.parentSearch$1("paragraph")) {
              t4 = this.filter_3;
              element = Y.Paragraph_analyze(t3, t2, t1, t4);
              t5 = this.elements_4;
              if (element != null)
                t5.push(element);
              else {
                t5.push(Y.Text_generate(t3, t2, t1, t4));
                ++t3.scanner.pos;
              }
              break;
            }
          ...
          if (element != null)
            ...
            t4.push(Y.Text_generate(t3, t2, t1, this.filter_3));
          ++t3.scanner.pos;
          break;
      }
    },
  ...
  Scanner: {
    ...
    read$1: function(relative_pos) {
      return this.pick$1(this.pos + relative_pos);
    },
    read$0: function() {
      return this.read$1(0);
    },
    scan$2: function(scanner, scanEnd) {
      var t1;
      for (; t1 = this.pos, t1 < this.tokens.length;)
        if (J.$eq(scanner.call$1(this.pick$1(t1)), true))
          break;
      if (scanEnd != null)
        if (this.pos >= this.tokens.length - 1)
          scanEnd.call$0();
    },
    scan$1: function(scanner) {
      return this.scan$2(scanner, null);
    }
  }
}],
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMImplementation|Navigator|NavigatorCPU|NavigatorUserMediaError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.dom.html", "dart:html", , W, {
  ...
  Event: {
    "^": "Interceptor;",
    "%": "AnimationPlayerEvent|AudioProcessingEvent|AutocompleteErrorEvent|BeforeUnloadEvent|CSSFontFaceLoadEvent|CompositionEvent|CustomEvent|DeviceLightEvent|DeviceMotionEvent|DeviceOrientationEvent|DragEvent|FetchEvent|FocusEvent|GamepadEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|InstallPhaseEvent|KeyboardEvent|MIDIConnectionEvent|MIDIMessageEvent|MSPointerEvent|MediaKeyEvent|MediaKeyMessageEvent|MediaKeyNeededEvent|MediaStreamEvent|MediaStreamTrackEvent|MessageEvent|MouseEvent|MouseScrollEvent|MouseWheelEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PointerEvent|PopStateEvent|PushEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|SVGZoomEvent|SecurityPolicyViolationEvent|SpeechRecognitionEvent|SpeechSynthesisEvent|TextEvent|TouchEvent|TrackEvent|TransitionEvent|UIEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent|WheelEvent;ClipboardEvent|Event|InputEvent"
  },
  EventTarget: {
    "^": "Interceptor;",
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var input, compile, t1;
    input = document.querySelector("#source");
    compile = new F.main_closure(input);
    compile.call$0();
    t1 = J.get$onInput$x(input);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure0(compile)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 2],
  main_closure: {
    "^": "Closure:10;input_0",
    call$0: function() {
      var note, a, html, tableOfContents, t1, t2, t3, errorHtml;
      note = new Y.Notex2(null, "article", null);
      note.source = J.get$value$x(this.input_0);
      note.id = "article";
      a = note.compile$0();
      html = a.toHtml$0();
      tableOfContents = a.genelateTableOfContentsHtml$1("");
      document.querySelector("#output").textContent = html;
      t1 = document.querySelector("#article_main");
      t2 = H.setRuntimeTypeInfo([], [W.NodeValidator]);
      t3 = new W.NodeValidatorBuilder(t2);
      t2.push(W._Html5NodeValidator$(null));
      t3.allowCustomElement$4$attributes$uriAttributes$uriPolicy("a", ["href"], null, null);
      t3.allowCustomElement$4$attributes$uriAttributes$uriPolicy("img", ["src"], null, null);
      t3.allowCustomElement$4$attributes$uriAttributes$uriPolicy("code", ["data-lang"], null, null);
      J.setInnerHtml$2$validator$x(t1, html, t3);
      t3 = document.querySelector("#tableOfContents");
      t1 = H.setRuntimeTypeInfo([], [W.NodeValidator]);
      t2 = new W.NodeValidatorBuilder(t1);
      t1.push(W._Html5NodeValidator$(null));
      t2.allowCustomElement$4$attributes$uriAttributes$uriPolicy("a", ["href"], null, null);
      J.setInnerHtml$2$validator$x(t3, tableOfContents, t2);
      for (t1 = note.parser.errors, t1 = new H.ListIterator(t1, t1.length, 0, null), errorHtml = "<ol>"; t1.moveNext$0();)
        errorHtml += "<li>" + t1.__internal$_current.get$description() + "</li>";
      errorHtml += "</ol>";
      J.setInnerHtml$1$x(document.querySelector("#error"), errorHtml);
    },
    $isFunction: true
  },
  main_closure0: {
...
{func: "dynamic__Token", args: [Y.Token]},
{func: "args0"},
...
function dart_precompiled($collectedClasses) {
  ...
  Element.prototype.set$lang = function(receiver, v) {
    return receiver.lang = v;
  };
  ...
  function Article(Notex20$Article$name, title, name, parent, children, attributes) {
    this.Notex20$Article$name = Notex20$Article$name;
    this.title = title;
    this.name = name;
    this.parent = parent;
  ...
  Article.prototype.get$name = function(receiver) {
    return this.Notex20$Article$name;
  };
  Article.prototype.get$title = function(receiver) {
    return this.title;
  };
  Article.prototype.set$title = function(receiver, v) {
    return this.title = v;
  };
  function Blockquote(Notex20$Blockquote$name, name, parent, children, attributes) {
    this.Notex20$Blockquote$name = Notex20$Blockquote$name;
    this.name = name;
    this.parent = parent;
    this.children = children;
    this.attributes = attributes;
  }
  Blockquote.builtin$cls = "Blockquote";
  if (!"name" in Blockquote)
    Blockquote.name = "Blockquote";
  $desc = $collectedClasses.Blockquote;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Blockquote.prototype = $desc;
  Blockquote.prototype.get$name = function(receiver) {
    return this.Notex20$Blockquote$name;
  };
  function Blockquote_generate_closure(parser_0) {
    this.parser_0 = parser_0;
  }
  Blockquote_generate_closure.builtin$cls = "Blockquote_generate_closure";
  if (!"name" in Blockquote_generate_closure)
    Blockquote_generate_closure.name = "Blockquote_generate_closure";
  $desc = $collectedClasses.Blockquote_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Blockquote_generate_closure.prototype = $desc;
  function Code(Notex20$Code$name, code, lang, name, parent, children, attributes) {
    this.Notex20$Code$name = Notex20$Code$name;
    this.code = code;
    this.lang = lang;
    this.name = name;
    this.parent = parent;
  ...
  if (!"name" in Code)
    Code.name = "Code";
  $desc = $collectedClasses.Code;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Code.prototype = $desc;
  Code.prototype.get$name = function(receiver) {
    return this.Notex20$Code$name;
  };
  Code.prototype.get$code = function(receiver) {
    return this.code;
  };
  Code.prototype.set$code = function(receiver, v) {
    return this.code = v;
  };
  Code.prototype.get$lang = function(receiver) {
    return this.lang;
  };
  Code.prototype.set$lang = function(receiver, v) {
    return this.lang = v;
  };
  function Code_generate_closure(parser_0, code_1) {
    this.parser_0 = parser_0;
    this.code_1 = code_1;
  }
  Code_generate_closure.builtin$cls = "Code_generate_closure";
  if (!"name" in Code_generate_closure)
    Code_generate_closure.name = "Code_generate_closure";
  $desc = $collectedClasses.Code_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Code_generate_closure.prototype = $desc;
  function Code_generate_closure0(parser_2, startToken_3) {
    this.parser_2 = parser_2;
    this.startToken_3 = startToken_3;
  }
  Code_generate_closure0.builtin$cls = "Code_generate_closure0";
  if (!"name" in Code_generate_closure0)
    Code_generate_closure0.name = "Code_generate_closure0";
  $desc = $collectedClasses.Code_generate_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Code_generate_closure0.prototype = $desc;
  function Element0(name, children) {
    this.name = name;
    this.children = children;
  }
  ...
  Element0.prototype.set$children = function(receiver, v) {
    return this.children = v;
  };
  function Image(Notex20$Image$name, url, name, parent, children, attributes) {
    this.Notex20$Image$name = Notex20$Image$name;
    this.url = url;
    this.name = name;
    this.parent = parent;
    this.children = children;
  ...
  Image.prototype.get$name = function(receiver) {
    return this.Notex20$Image$name;
  };
  Image.prototype.get$url = function(receiver) {
    return this.url;
  };
  Image.prototype.set$url = function(receiver, v) {
    return this.url = v;
  };
  function Image_generate_closure(parser_0, img_1) {
    this.parser_0 = parser_0;
    this.img_1 = img_1;
  }
  Image_generate_closure.builtin$cls = "Image_generate_closure";
  if (!"name" in Image_generate_closure)
    Image_generate_closure.name = "Image_generate_closure";
  $desc = $collectedClasses.Image_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Image_generate_closure.prototype = $desc;
  function Image_generate_closure0(parser_2, startToken_3) {
    this.parser_2 = parser_2;
    this.startToken_3 = startToken_3;
  }
  Image_generate_closure0.builtin$cls = "Image_generate_closure0";
  if (!"name" in Image_generate_closure0)
    Image_generate_closure0.name = "Image_generate_closure0";
  $desc = $collectedClasses.Image_generate_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Image_generate_closure0.prototype = $desc;
  function Keyword(Notex20$Keyword$name, name, parent, children, attributes) {
    this.Notex20$Keyword$name = Notex20$Keyword$name;
    this.name = name;
    this.parent = parent;
    this.children = children;
    this.attributes = attributes;
  }
  Keyword.builtin$cls = "Keyword";
  if (!"name" in Keyword)
    Keyword.name = "Keyword";
  $desc = $collectedClasses.Keyword;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Keyword.prototype = $desc;
  Keyword.prototype.get$name = function(receiver) {
    return this.Notex20$Keyword$name;
  };
  function Keyword_generate_closure(parser_0) {
    this.parser_0 = parser_0;
  }
  Keyword_generate_closure.builtin$cls = "Keyword_generate_closure";
  if (!"name" in Keyword_generate_closure)
    Keyword_generate_closure.name = "Keyword_generate_closure";
  $desc = $collectedClasses.Keyword_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Keyword_generate_closure.prototype = $desc;
  function Keyword_generate_closure0(parser_1, startToken_2) {
    this.parser_1 = parser_1;
    this.startToken_2 = startToken_2;
  }
  Keyword_generate_closure0.builtin$cls = "Keyword_generate_closure0";
  if (!"name" in Keyword_generate_closure0)
    Keyword_generate_closure0.name = "Keyword_generate_closure0";
  $desc = $collectedClasses.Keyword_generate_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Keyword_generate_closure0.prototype = $desc;
  function Link(Notex20$Link$name, url, name, parent, children, attributes) {
    this.Notex20$Link$name = Notex20$Link$name;
    this.url = url;
    this.name = name;
    this.parent = parent;
    this.children = children;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Link.prototype = $desc;
  Link.prototype.get$name = function(receiver) {
    return this.Notex20$Link$name;
  };
  Link.prototype.get$url = function(receiver) {
    return this.url;
  };
  Link.prototype.set$url = function(receiver, v) {
    return this.url = v;
  };
  function Link_generate_closure(parser_0, filter_1, link_2) {
    this.parser_0 = parser_0;
    this.filter_1 = filter_1;
    this.link_2 = link_2;
  }
  Link_generate_closure.builtin$cls = "Link_generate_closure";
  if (!"name" in Link_generate_closure)
    Link_generate_closure.name = "Link_generate_closure";
  $desc = $collectedClasses.Link_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Link_generate_closure.prototype = $desc;
  function Link_generate__closure() {
  }
  Link_generate__closure.builtin$cls = "Link_generate__closure";
  if (!"name" in Link_generate__closure)
    Link_generate__closure.name = "Link_generate__closure";
  $desc = $collectedClasses.Link_generate__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Link_generate__closure.prototype = $desc;
  function Link_generate_closure0(parser_3, startToken_4) {
    this.parser_3 = parser_3;
    this.startToken_4 = startToken_4;
  }
  Link_generate_closure0.builtin$cls = "Link_generate_closure0";
  if (!"name" in Link_generate_closure0)
    Link_generate_closure0.name = "Link_generate_closure0";
  $desc = $collectedClasses.Link_generate_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Link_generate_closure0.prototype = $desc;
  function Link_generate_closure1(parser_5, link_6) {
    this.parser_5 = parser_5;
    this.link_6 = link_6;
  }
  Link_generate_closure1.builtin$cls = "Link_generate_closure1";
  if (!"name" in Link_generate_closure1)
    Link_generate_closure1.name = "Link_generate_closure1";
  $desc = $collectedClasses.Link_generate_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Link_generate_closure1.prototype = $desc;
  function Link_generate_closure2(parser_7, startToken_8) {
    this.parser_7 = parser_7;
    this.startToken_8 = startToken_8;
  }
  Link_generate_closure2.builtin$cls = "Link_generate_closure2";
  if (!"name" in Link_generate_closure2)
    Link_generate_closure2.name = "Link_generate_closure2";
  $desc = $collectedClasses.Link_generate_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Link_generate_closure2.prototype = $desc;
  function EList(Notex20$EList$name, type, name, parent, children, attributes) {
    this.Notex20$EList$name = Notex20$EList$name;
    this.type = type;
    this.name = name;
    this.parent = parent;
    this.children = children;
  ...
  EList.builtin$cls = "EList";
  if (!"name" in EList)
    EList.name = "EList";
  $desc = $collectedClasses.EList;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EList.prototype = $desc;
  EList.prototype.get$name = function(receiver) {
    return this.Notex20$EList$name;
  };
  function EList_generate_closure(box_1, parser_2, list_3) {
    this.box_1 = box_1;
    this.parser_2 = parser_2;
    this.list_3 = list_3;
  }
  EList_generate_closure.builtin$cls = "EList_generate_closure";
  if (!"name" in EList_generate_closure)
    EList_generate_closure.name = "EList_generate_closure";
  $desc = $collectedClasses.EList_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EList_generate_closure.prototype = $desc;
  function EList_generate_closure0(box_1, parser_4, list_5) {
    this.box_1 = box_1;
    this.parser_4 = parser_4;
    this.list_5 = list_5;
  }
  EList_generate_closure0.builtin$cls = "EList_generate_closure0";
  if (!"name" in EList_generate_closure0)
    EList_generate_closure0.name = "EList_generate_closure0";
  $desc = $collectedClasses.EList_generate_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EList_generate_closure0.prototype = $desc;
  function EList_generate__closure(box_0, box_1, parser_6, item_7) {
    this.box_0 = box_0;
    this.box_1 = box_1;
    this.parser_6 = parser_6;
    this.item_7 = item_7;
  }
  EList_generate__closure.builtin$cls = "EList_generate__closure";
  if (!"name" in EList_generate__closure)
    EList_generate__closure.name = "EList_generate__closure";
  $desc = $collectedClasses.EList_generate__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EList_generate__closure.prototype = $desc;
  function EList_generate_closure1(parser_8, startToken_9) {
    this.parser_8 = parser_8;
    this.startToken_9 = startToken_9;
  }
  EList_generate_closure1.builtin$cls = "EList_generate_closure1";
  if (!"name" in EList_generate_closure1)
    EList_generate_closure1.name = "EList_generate_closure1";
  $desc = $collectedClasses.EList_generate_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EList_generate_closure1.prototype = $desc;
  function EList_getNextHierarchy_closure(box_0, parser_1) {
    this.box_0 = box_0;
    this.parser_1 = parser_1;
  }
  EList_getNextHierarchy_closure.builtin$cls = "EList_getNextHierarchy_closure";
  if (!"name" in EList_getNextHierarchy_closure)
    EList_getNextHierarchy_closure.name = "EList_getNextHierarchy_closure";
  $desc = $collectedClasses.EList_getNextHierarchy_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EList_getNextHierarchy_closure.prototype = $desc;
  function EList_getNextStep_closure(box_0, parser_1) {
    this.box_0 = box_0;
    this.parser_1 = parser_1;
  }
  EList_getNextStep_closure.builtin$cls = "EList_getNextStep_closure";
  if (!"name" in EList_getNextStep_closure)
    EList_getNextStep_closure.name = "EList_getNextStep_closure";
  $desc = $collectedClasses.EList_getNextStep_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EList_getNextStep_closure.prototype = $desc;
  function EListItem(Notex20$EListItem$name, name, parent, children, attributes) {
    this.Notex20$EListItem$name = Notex20$EListItem$name;
    this.name = name;
    this.parent = parent;
    this.children = children;
    this.attributes = attributes;
  }
  EListItem.builtin$cls = "EListItem";
  if (!"name" in EListItem)
    EListItem.name = "EListItem";
  $desc = $collectedClasses.EListItem;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EListItem.prototype = $desc;
  EListItem.prototype.get$name = function(receiver) {
    return this.Notex20$EListItem$name;
  };
  function MultiLineCode(Notex20$MultiLineCode$name, code, lang, name, parent, children, attributes) {
    this.Notex20$MultiLineCode$name = Notex20$MultiLineCode$name;
    this.code = code;
    this.lang = lang;
    this.name = name;
    this.parent = parent;
  ...
  MultiLineCode.builtin$cls = "MultiLineCode";
  if (!"name" in MultiLineCode)
    MultiLineCode.name = "MultiLineCode";
  $desc = $collectedClasses.MultiLineCode;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MultiLineCode.prototype = $desc;
  MultiLineCode.prototype.get$name = function(receiver) {
    return this.Notex20$MultiLineCode$name;
  };
  MultiLineCode.prototype.get$code = function(receiver) {
    return this.code;
  };
  MultiLineCode.prototype.set$code = function(receiver, v) {
    return this.code = v;
  };
  MultiLineCode.prototype.get$lang = function(receiver) {
    return this.lang;
  };
  MultiLineCode.prototype.set$lang = function(receiver, v) {
    return this.lang = v;
  };
  function MultiLineCode_generate_closure(parser_0, code_1) {
    this.parser_0 = parser_0;
    this.code_1 = code_1;
  }
  MultiLineCode_generate_closure.builtin$cls = "MultiLineCode_generate_closure";
  if (!"name" in MultiLineCode_generate_closure)
    MultiLineCode_generate_closure.name = "MultiLineCode_generate_closure";
  $desc = $collectedClasses.MultiLineCode_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MultiLineCode_generate_closure.prototype = $desc;
  function MultiLineCode_generate_closure0(parser_2, code_3) {
    this.parser_2 = parser_2;
    this.code_3 = code_3;
  }
  MultiLineCode_generate_closure0.builtin$cls = "MultiLineCode_generate_closure0";
  if (!"name" in MultiLineCode_generate_closure0)
    MultiLineCode_generate_closure0.name = "MultiLineCode_generate_closure0";
  $desc = $collectedClasses.MultiLineCode_generate_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MultiLineCode_generate_closure0.prototype = $desc;
  function MultiLineCode_generate_closure1(parser_4, startToken_5) {
    this.parser_4 = parser_4;
    this.startToken_5 = startToken_5;
  }
  MultiLineCode_generate_closure1.builtin$cls = "MultiLineCode_generate_closure1";
  if (!"name" in MultiLineCode_generate_closure1)
    MultiLineCode_generate_closure1.name = "MultiLineCode_generate_closure1";
  $desc = $collectedClasses.MultiLineCode_generate_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MultiLineCode_generate_closure1.prototype = $desc;
  function Paragraph(Notex20$Paragraph$name, name, parent, children, attributes) {
    this.Notex20$Paragraph$name = Notex20$Paragraph$name;
    this.name = name;
    this.parent = parent;
    this.children = children;
    this.attributes = attributes;
  }
  Paragraph.builtin$cls = "Paragraph";
  if (!"name" in Paragraph)
    Paragraph.name = "Paragraph";
  $desc = $collectedClasses.Paragraph;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Paragraph.prototype = $desc;
  Paragraph.prototype.get$name = function(receiver) {
    return this.Notex20$Paragraph$name;
  };
  function Paragraph_generate_closure(parser_0, inspecter_1) {
    this.parser_0 = parser_0;
    this.inspecter_1 = inspecter_1;
  }
  Paragraph_generate_closure.builtin$cls = "Paragraph_generate_closure";
  if (!"name" in Paragraph_generate_closure)
    Paragraph_generate_closure.name = "Paragraph_generate_closure";
  $desc = $collectedClasses.Paragraph_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Paragraph_generate_closure.prototype = $desc;
  function Section(Notex20$Section$name, hierarchy, title, number, name, parent, children, attributes) {
    this.Notex20$Section$name = Notex20$Section$name;
  ...
  Section.builtin$cls = "Section";
  if (!"name" in Section)
    Section.name = "Section";
  $desc = $collectedClasses.Section;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Section.prototype = $desc;
  Section.prototype.get$name = function(receiver) {
    return this.Notex20$Section$name;
  };
  Section.prototype.get$hierarchy = function() {
    return this.hierarchy;
  };
  Section.prototype.get$title = function(receiver) {
    return this.title;
  };
  Section.prototype.set$title = function(receiver, v) {
    return this.title = v;
  };
  Section.prototype.get$number = function() {
    return this.number;
  };
  function Section_generate_closure(box_1, parser_2, section_3) {
    this.box_1 = box_1;
    this.parser_2 = parser_2;
    this.section_3 = section_3;
  }
  Section_generate_closure.builtin$cls = "Section_generate_closure";
  if (!"name" in Section_generate_closure)
    Section_generate_closure.name = "Section_generate_closure";
  $desc = $collectedClasses.Section_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Section_generate_closure.prototype = $desc;
  function Section_generate__closure(parser_4, section_5) {
    this.parser_4 = parser_4;
    this.section_5 = section_5;
  }
  Section_generate__closure.builtin$cls = "Section_generate__closure";
  if (!"name" in Section_generate__closure)
    Section_generate__closure.name = "Section_generate__closure";
  $desc = $collectedClasses.Section_generate__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Section_generate__closure.prototype = $desc;
  function Section_generate___closure(box_0, parser_6) {
    this.box_0 = box_0;
    this.parser_6 = parser_6;
  }
  Section_generate___closure.builtin$cls = "Section_generate___closure";
  if (!"name" in Section_generate___closure)
    Section_generate___closure.name = "Section_generate___closure";
  $desc = $collectedClasses.Section_generate___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Section_generate___closure.prototype = $desc;
  function Strike(Notex20$Strike$name, name, parent, children, attributes) {
    this.Notex20$Strike$name = Notex20$Strike$name;
    this.name = name;
    this.parent = parent;
    this.children = children;
    this.attributes = attributes;
  }
  Strike.builtin$cls = "Strike";
  if (!"name" in Strike)
    Strike.name = "Strike";
  $desc = $collectedClasses.Strike;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Strike.prototype = $desc;
  Strike.prototype.get$name = function(receiver) {
    return this.Notex20$Strike$name;
  };
  function Strike_generate_closure(parser_0) {
    this.parser_0 = parser_0;
  }
  Strike_generate_closure.builtin$cls = "Strike_generate_closure";
  if (!"name" in Strike_generate_closure)
    Strike_generate_closure.name = "Strike_generate_closure";
  $desc = $collectedClasses.Strike_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Strike_generate_closure.prototype = $desc;
  function Strike_generate_closure0(parser_1, startToken_2) {
    this.parser_1 = parser_1;
    this.startToken_2 = startToken_2;
  }
  Strike_generate_closure0.builtin$cls = "Strike_generate_closure0";
  if (!"name" in Strike_generate_closure0)
    Strike_generate_closure0.name = "Strike_generate_closure0";
  $desc = $collectedClasses.Strike_generate_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Strike_generate_closure0.prototype = $desc;
  function Strong(Notex20$Strong$name, name, parent, children, attributes) {
    this.Notex20$Strong$name = Notex20$Strong$name;
    this.name = name;
    this.parent = parent;
    this.children = children;
    this.attributes = attributes;
  }
  Strong.builtin$cls = "Strong";
  if (!"name" in Strong)
    Strong.name = "Strong";
  $desc = $collectedClasses.Strong;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Strong.prototype = $desc;
  Strong.prototype.get$name = function(receiver) {
    return this.Notex20$Strong$name;
  };
  function Strong_generate_closure(parser_0) {
    this.parser_0 = parser_0;
  }
  Strong_generate_closure.builtin$cls = "Strong_generate_closure";
  if (!"name" in Strong_generate_closure)
    Strong_generate_closure.name = "Strong_generate_closure";
  $desc = $collectedClasses.Strong_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Strong_generate_closure.prototype = $desc;
  function Strong_generate_closure0(parser_1, startToken_2) {
    this.parser_1 = parser_1;
    this.startToken_2 = startToken_2;
  }
  Strong_generate_closure0.builtin$cls = "Strong_generate_closure0";
  if (!"name" in Strong_generate_closure0)
    Strong_generate_closure0.name = "Strong_generate_closure0";
  $desc = $collectedClasses.Strong_generate_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Strong_generate_closure0.prototype = $desc;
  function Table(Notex20$Table$name, name, parent, children, attributes) {
    this.Notex20$Table$name = Notex20$Table$name;
    this.name = name;
    this.parent = parent;
    this.children = children;
    this.attributes = attributes;
  ...
  Table.prototype.get$name = function(receiver) {
    return this.Notex20$Table$name;
  };
  function Table_generate_closure(parser_1, table_2) {
    this.parser_1 = parser_1;
    this.table_2 = table_2;
  }
  Table_generate_closure.builtin$cls = "Table_generate_closure";
  if (!"name" in Table_generate_closure)
    Table_generate_closure.name = "Table_generate_closure";
  $desc = $collectedClasses.Table_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Table_generate_closure.prototype = $desc;
  function Table_generate__closure(parser_3, tr_4) {
    this.parser_3 = parser_3;
    this.tr_4 = tr_4;
  }
  Table_generate__closure.builtin$cls = "Table_generate__closure";
  if (!"name" in Table_generate__closure)
    Table_generate__closure.name = "Table_generate__closure";
  $desc = $collectedClasses.Table_generate__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Table_generate__closure.prototype = $desc;
  function Table_generate___closure(box_0, parser_5) {
    this.box_0 = box_0;
    this.parser_5 = parser_5;
  }
  Table_generate___closure.builtin$cls = "Table_generate___closure";
  if (!"name" in Table_generate___closure)
    Table_generate___closure.name = "Table_generate___closure";
  $desc = $collectedClasses.Table_generate___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Table_generate___closure.prototype = $desc;
  function Table_generate___closure0(box_0, parser_6) {
    this.box_0 = box_0;
    this.parser_6 = parser_6;
  }
  Table_generate___closure0.builtin$cls = "Table_generate___closure0";
  if (!"name" in Table_generate___closure0)
    Table_generate___closure0.name = "Table_generate___closure0";
  $desc = $collectedClasses.Table_generate___closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Table_generate___closure0.prototype = $desc;
  function Table_generate___closure1() {
  }
  Table_generate___closure1.builtin$cls = "Table_generate___closure1";
  if (!"name" in Table_generate___closure1)
    Table_generate___closure1.name = "Table_generate___closure1";
  $desc = $collectedClasses.Table_generate___closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Table_generate___closure1.prototype = $desc;
  function Table_generate___closure2(box_0, parser_7) {
    this.box_0 = box_0;
    this.parser_7 = parser_7;
  }
  Table_generate___closure2.builtin$cls = "Table_generate___closure2";
  if (!"name" in Table_generate___closure2)
    Table_generate___closure2.name = "Table_generate___closure2";
  $desc = $collectedClasses.Table_generate___closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Table_generate___closure2.prototype = $desc;
  function Table_generate___closure3(box_0, parser_8) {
    this.box_0 = box_0;
    this.parser_8 = parser_8;
  }
  Table_generate___closure3.builtin$cls = "Table_generate___closure3";
  if (!"name" in Table_generate___closure3)
    Table_generate___closure3.name = "Table_generate___closure3";
  $desc = $collectedClasses.Table_generate___closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Table_generate___closure3.prototype = $desc;
  function Table_generate___closure4() {
  }
  Table_generate___closure4.builtin$cls = "Table_generate___closure4";
  if (!"name" in Table_generate___closure4)
    Table_generate___closure4.name = "Table_generate___closure4";
  $desc = $collectedClasses.Table_generate___closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Table_generate___closure4.prototype = $desc;
  function TableData(Notex20$TableData$name, colspan, rowspan, name, parent, children, attributes) {
    this.Notex20$TableData$name = Notex20$TableData$name;
  ...
  TableData.builtin$cls = "TableData";
  if (!"name" in TableData)
    TableData.name = "TableData";
  $desc = $collectedClasses.TableData;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TableData.prototype = $desc;
  TableData.prototype.get$name = function(receiver) {
    return this.Notex20$TableData$name;
  };
  function TableHeader(Notex20$TableHeader$name, colspan, rowspan, name, parent, children, attributes) {
    this.Notex20$TableHeader$name = Notex20$TableHeader$name;
    this.colspan = colspan;
    this.rowspan = rowspan;
    this.name = name;
    this.parent = parent;
  ...
  TableHeader.builtin$cls = "TableHeader";
  if (!"name" in TableHeader)
    TableHeader.name = "TableHeader";
  $desc = $collectedClasses.TableHeader;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TableHeader.prototype = $desc;
  TableHeader.prototype.get$name = function(receiver) {
    return this.Notex20$TableHeader$name;
  };
  function TableRow(Notex20$TableRow$name, name, parent, children, attributes) {
    this.Notex20$TableRow$name = Notex20$TableRow$name;
    this.name = name;
    this.parent = parent;
    this.children = children;
    this.attributes = attributes;
  ...
  TableRow.prototype.get$name = function(receiver) {
    return this.Notex20$TableRow$name;
  };
  function Text(Notex20$Text$name, text, name, parent, children, attributes) {
    this.Notex20$Text$name = Notex20$Text$name;
    this.text = text;
    this.name = name;
    this.parent = parent;
    this.children = children;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Text.prototype = $desc;
  Text.prototype.get$name = function(receiver) {
    return this.Notex20$Text$name;
  };
  function Text_generate_closure(parser_0, inspecter_1, text_2) {
    this.parser_0 = parser_0;
    this.inspecter_1 = inspecter_1;
    this.text_2 = text_2;
  }
  Text_generate_closure.builtin$cls = "Text_generate_closure";
  if (!"name" in Text_generate_closure)
    Text_generate_closure.name = "Text_generate_closure";
  $desc = $collectedClasses.Text_generate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Text_generate_closure.prototype = $desc;
  ...
  function Lexer_analyze_tokeniza(box_0, this_1) {
    this.box_0 = box_0;
    this.this_1 = this_1;
  }
  Lexer_analyze_tokeniza.builtin$cls = "Lexer_analyze_tokeniza";
  if (!"name" in Lexer_analyze_tokeniza)
    Lexer_analyze_tokeniza.name = "Lexer_analyze_tokeniza";
  $desc = $collectedClasses.Lexer_analyze_tokeniza;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Lexer_analyze_tokeniza.prototype = $desc;
  function Token(id, token, lexeme, row, col) {
    this.id = id;
    this.token = token;
    this.lexeme = lexeme;
    this.row = row;
  ...
  Token.prototype.set$id = function(receiver, v) {
    return this.id = v;
  };
  Token.prototype.get$token = function() {
    return this.token;
  };
  function Notex2(source, id, parser) {
    this.source = source;
    this.id = id;
    this.parser = parser;
  }
  Notex2.builtin$cls = "Notex2";
  if (!"name" in Notex2)
    Notex2.name = "Notex2";
  $desc = $collectedClasses.Notex2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Notex2.prototype = $desc;
  Notex2.prototype.get$id = function(receiver) {
    return this.id;
  };
  Notex2.prototype.set$id = function(receiver, v) {
    return this.id = v;
  };
  function Notex2_compile_closure() {
  }
  Notex2_compile_closure.builtin$cls = "Notex2_compile_closure";
  if (!"name" in Notex2_compile_closure)
    Notex2_compile_closure.name = "Notex2_compile_closure";
  $desc = $collectedClasses.Notex2_compile_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Notex2_compile_closure.prototype = $desc;
  function Error0(description, row, col) {
  ...
  if (!"name" in Error0)
    Error0.name = "Error0";
  $desc = $collectedClasses.Error0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Error0.prototype = $desc;
  Error0.prototype.get$description = function() {
    return this.description;
  };
  function Parser(scanner, sectionCount, errors) {
  ...
  function Parser_analyze_closure(this_0, parent_1, inspecter_2, filter_3, elements_4) {
    this.this_0 = this_0;
    this.parent_1 = parent_1;
    this.inspecter_2 = inspecter_2;
    this.filter_3 = filter_3;
    this.elements_4 = elements_4;
  }
  Parser_analyze_closure.builtin$cls = "Parser_analyze_closure";
  if (!"name" in Parser_analyze_closure)
    Parser_analyze_closure.name = "Parser_analyze_closure";
  $desc = $collectedClasses.Parser_analyze_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Parser_analyze_closure.prototype = $desc;
  function Scanner(tokens, pos) {
    this.tokens = tokens;
    this.pos = pos;
  }
  ...
  function main_closure0(compile_1) {
    this.compile_1 = compile_1;
  }
